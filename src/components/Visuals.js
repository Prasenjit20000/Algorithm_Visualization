...
function Visuals() {
   ...
   const changeValues = () => {
      //only fires the dispatch for changing values randomly
  ...
  return (
   <div className="visuals">
      <div className="visualizer">
         ...
         {myState.algorithm==='selection' && <div className="legend"><div className="legend__lable"></div> Minimum element</div>}
         {
